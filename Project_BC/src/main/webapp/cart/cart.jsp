...
<body>
	<div id="wrap">	
		...
		<form action="Order.do">
			<div id="content">
				<div id="title">
					<img alt="" src="https://www.thebanchan.co.kr/fo/images/odr/ico_tit_cart.png" id="img_cart">
					장바구니
				</div>
		...
		<!-- 			<caption>장바구니 | 제품전체선택, 제품정보, 판매금액, 수량, 구매금액, 선택으로 이루어진 장바구니</caption> -->
					...
					<tbody>
						<tr>
							...
							<td>
								<div class="img">
									<img src="https://cdn.thebanchan.co.kr/upload/C00001/goods/prd/100/624/200715000025624.jpg" width="100" height="100">
								</div>
								<div class="txt">
				...
				<div class="order">
					...
					<input type="submit" value="선택제품 주문">		
				</div>
			</div>
		</form>
		<div id="clear"></div>
