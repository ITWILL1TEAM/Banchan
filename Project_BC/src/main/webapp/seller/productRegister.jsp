                            ...
                            <form name=product action="BoardWritePro.do" method="post">
                                <table >
                                   <tbody>
										...
										<tr><td>회사명</td><td><input type="text" name = Sname size=10></td></tr>
										<tr><td>제품품목</td><td><input type="text" name = product_category size=10></td></tr>
										<tr><td>상품가격</td><td><input type="text" name = product_price size=10></td></tr>
										<tr><td>제품무게</td><td><input type="text" name = product_weight size=10></td></tr>
										<tr><td>제품총재고</td><td><input type="text" name = product_stock size=10></td></tr>
