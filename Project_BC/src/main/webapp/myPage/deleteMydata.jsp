			...
			<li>
				<dl>
					...
					<!-- <dd><a id="left_12" href="#">주문정보 수신 설정</a></dd> -->
						...
						<dd><a id="left_14" href="Delete.my" onclick="" class="on">회원탈퇴</a></dd>
			...
			<!-- MY CONFIRM -->
			  <form id="confirmForm" onsubmit="return true">
				...
				<div class="mys_cfm">
					...
					<!-- <div class="txt">회원 탈퇴를 위해서는 본인 확인이 필요합니다.<br/>비밀번호를 입력해 주시기 바랍니다.</div> -->
					<dl>
					...
					<div class="btn"><button id="saveBtn" type="button"><em>확인</em></button></div>
				</div>
			</form>
			<!-- MY CONFIRM -->
