		...
		<form action="QnaModifyPro.qa" method="post" name="modifyForm">
			...
			<table>
				<tr>
					...
					<td class="td_right">
						<input type="text" name="board_name" required="required" value=<%=article.getCustomer_id() %> />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="td_right">
						<input type="text" name="board_subject" required="required" value=<%=article.getQna_subject() %> />
					</td>
				</tr>
				<tr>
					...
					<td class="td_right">
						<textarea id="board_content" name="board_content" cols="40" rows="15" 
									required="required"><%=article.getQna_content() %></textarea>
					</td>
				</tr>
			</table>
